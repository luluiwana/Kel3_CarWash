              ...
              <div class="modal-body">
                <form class="form-horizontal">
				  ...
				  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" id="inputEmail" placeholder="Nama lengkap">
                    </div>
                  </div>
				  <div class="control-group">
                    <label class="control-label" for="inputEmail">Alamat</label>
                    <div class="controls">
                      <input type="text" id="inputEmail" placeholder="Alamat">
                    </div>
                  </div>
				  <div class="control-group">
                    <label class="control-label" for="inputEmail">Tanggal Lahir</label>
                    <div class="controls">
                      <input type="text" id="inputEmail" placeholder="Tanggal lahir">
                    </div>
                  </div>
				  <div class="control-group">
                    <label class="control-label" for="inputEmail">Jenis Kelamin</label>
                    <div class="controls">
                      <input type="text" id="inputEmail" placeholder="Jenis kelamin">
                    </div>
                  </div>
				  <div class="control-group">
                    <label class="control-label" for="inputEmail">Nomor HP</label>
                    <div class="controls">
                      <input type="text" id="inputEmail" placeholder="Nomor HP">
                    </div>
                  </div>
                  <div class="control-group">
              ...
              <div class="navigation">
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      <a href="#">Feedback<i class="icon-angle-down"></i></a>
                      <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                      <a href="#">Tanya<i class="icon-angle-down"></i></a>
                      <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                      <a href="#">FAQ<i class="icon-angle-down"></i></a>
                      <ul class="dropdown-menu">
    ...
    <section id="featured">
      ...
      <div id="nivo-slider">
        <div class="nivo-slider">
          <!-- Slide #1 image -->
          <img src="https://autolife.co.nz/wp-content/uploads/2018/03/carwash-header-website.jpg" alt="" title="#caption-1" />
          <!-- Slide #2 image -->
